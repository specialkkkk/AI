...
from tensorflow.keras.layers import Dense,SimpleRNN,Dropout,LSTM,Flatten,Conv2D
...
#2. 모델구성
model = Sequential()  
model.add(Conv2D(units=64, input_shape=(2, 2, 1), activation='relu'))  
model = Flatten()
